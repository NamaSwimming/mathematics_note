...
\begin{mycolumn}
  ...
  本書では以下，とくに断らない限り有限生成な線型空間のみを扱う．
...
したがって「有限生成」と「有限次元」は同じクラスの線型空間を指す言葉であり，本書で扱う線型空間は，とくに断らない限り有限次元である（\deref{有限生成}のあとのコラムを参照）．
...
\begin{mycolumn}
  ...
  また，\coref{次元による基底の判定}と\prref{行列式と階数}を合わせると，
