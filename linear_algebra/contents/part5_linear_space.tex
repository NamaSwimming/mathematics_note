...
\begin{proof}
  ...
  以上の考察により，$W_1+W_2$も$V$の線型部分空間である．
\end{proof}
\end{tleftbar}
...
\begin{prop}{和と線型包}{和と線型包}
  $V$を線型空間，$W_1, W_2$を$V$の線型部分空間とする．このとき，次の等式が成り立つ：
  \[
...
\[
  \begin{aligned}
    &\text{$W_1$の基底} \qquad
    &&(\bm{u}_1, \dots, \bm{u}_r, \bm{x}_1, \dots, \bm{x}_s),\\
    &\text{$W_2$の基底}
    &&(\bm{u}_1, \dots, \bm{u}_r, \bm{y}_1, \dots, \bm{y}_t)
  \end{aligned}
\]
