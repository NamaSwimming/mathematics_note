...
\emph{定理theorem）}\index{ていり@定理}（とは，正しいと分かっている数学の主張\footnote{つまり，「狭い意味での命題」のこと．}の中でもとりわけ重要なものを指す．\textbf{Thm}と略記される．
    ...
    \begin{example}{帰納法}{帰納法}
      ...
      集合はしばしば条件を用いて記述される．
        ...
        \begin{definition}{写像}{写像}
          $A$，$B$を集合とする．
          $f \colon A \to B$が\emph{写像}\index{しゃぞう@写像}であるとは，$G$が次の2つの条件を満たすことである．
