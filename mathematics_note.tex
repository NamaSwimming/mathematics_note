...
次に，以下のような漸化式で定められた数列$(x_n)_{n \in \mathbb{N}}$を考える：
\[
\begin{cases}
x_1 =0 ,\\
x_{n+1}= \sqrt{x_n+2}.
...
\begin{dotleftbar}
\begin{proof}
先の命題により，任意の$n \in \mathbb{N}$について，$ x_n \leqq x_{n+1} <2$なので，
...
以上の考察により，数列$(x_n)_{n \in \mathbb{N}}$は収束する．\qed 
\end{tleftbar}
...
\newpage 
      ...
      \phantomsection
        ...
        この例では，$f(1)$と$f(3)$がともに$a$に対応しているが，上記の写像の定義ではこのような場合があってもよい．
        また，$A$のどの元にも対応しない要素$c$の存在も許容される．
