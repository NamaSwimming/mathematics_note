...
\newpage 
      ...
      \phantomsection
        ...
        \begin{example}{キーボードと文字}{キーボードと文字} 
          集合$A$をキーボード上のキーの集合，集合$B$をスクリーンに表示される文字の集合とする．
          各キー$a \in A$に対して，それを押すとスクリーンに表示される文字を$b \in B$とする．
          このとき，
        \[
        b=f(a)
        \]
          と考えると，キーに対して特定の文字が対応するので，$f$は写像の定義を満たす．
        \end{example}
