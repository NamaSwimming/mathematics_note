...
\begin{definition}{記号$\exists!$}{一意存在の記号}
  ...
  \[
    \exists \, y \in B \, : \, \Bigl( P(y) \land \bigl( \forall z \in B \, : \, ( P(z) \to z = y ) \bigr) \Bigr)
  \]
  の略記である．
\end{definition}

すなわち，$\exists! \, y \in B : P(y)$は，
\begin{itemize}
...
\begin{tleftbar}
  \begin{proof}
    ...
    \begin{align*}
      ...
      & \iff \bigl( f(a) \in B_1 \bigr) \land \bigl( f(a) \in B_2 \bigr) \\
      & \iff \bigl( a \in f^{-1}(B_1) \bigr) \land \bigl( a \in f^{-1}(B_2) \bigr) \\
