...
\begin{proof}
  ...
  \[
    n \geqq n_0 \implies \abs{a_n - a} < \varepsilon, \quad n \geqq n_1 \implies \abs{a_n - b} < \varepsilon
  \]
...
\[
a_n+b_n=1+\frac1n\longrightarrow1
\]
である．
...
\begin{proof}
  ...
  \begin{align}
    n \geqq n_1 &\implies a - \varepsilon < a_n < a + \varepsilon \\
    n \geqq n_2 &\implies a - \varepsilon < b_n < a + \varepsilon
  \end{align}
